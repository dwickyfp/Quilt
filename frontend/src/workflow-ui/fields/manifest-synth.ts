...
export function portsForComponent(comp: ComponentDef): NodePorts {
    ...
    // Feature Selector - labeled data in, selection-path table out.
    if (id === 'ml.featureselect') {
        return {
            inputs: [MAIN_IN],
            outputs: [MAIN_OUT],
        };
        ...
        return base(comp, [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        kind: 'integer',
                        defaultValue: 5,
                        description: 'Number of cross-validation folds (min 2).',
                    },
                    {
                        key: 'seed',
                        label: 'Seed',
                    ...
                    {
                        key: 'maxDepth',
                        label: 'Max depth (tree/forest/xgb)',
                        kind: 'integer',
                        defaultValue: 10,
                    },
                    {
                        key: 'nTrees',
                        label: 'Trees / boosting iterations (forest/xgb)',
                        kind: 'integer',
                        defaultValue: 100,
                    },
                    {
                        key: 'k',
                        label: 'Neighbors k (knn)',
                        kind: 'integer',
                        defaultValue: 5,
                    },
                    {
                        key: 'alpha',
                        label: 'Alpha (ridge/lasso/elasticnet)',
                        kind: 'number',
                        defaultValue: 1.0,
                    },
                    {
                        key: 'l1Ratio',
                        label: 'L1 ratio (elasticnet)',
                        kind: 'number',
                        defaultValue: 0.5,
                    },
                    {
        ...
        return base(comp, [
            {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        kind: 'columns',
                        description: 'Candidate pool to select from. Leave empty to consider all other columns.',
                    },
                    {
                        key: 'task',
                        label: 'Task',
                    ...
                    {
                        key: 'maxFeatures',
                        label: 'Max features (0 = no cap)',
                        kind: 'integer',
                        defaultValue: 0,
                        description: 'Stop after selecting this many features. 0 selects until no candidate improves the score.',
                    },
                    {
                        key: 'folds',
                        label: 'Folds (k)',
