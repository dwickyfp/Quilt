        ...
        groups: [
            ...
            },
            {
                ...
                components: [
                    ...
                    ml('ml.learner.svc', 'Support Vector Classifier', 'available', 'Train a support vector machine classifier (binary). Props: targetColumn, featureColumns, kernel (linear|rbf, default rbf), c (regularization, default 1.0), gamma (kernel coeff, default 0 = auto). Outputs a model on the model port.'),
                    ml('ml.learner.svr', 'Support Vector Regressor', 'available', 'Train a support vector machine regressor (numeric target). Props: targetColumn (numeric), featureColumns, kernel (linear|rbf, default rbf), c (regularization, default 1.0), epsilon (margin width, default 0.1), gamma (kernel coeff, default 0 = auto). Outputs a model on the model port.'),
                ],
            },
            {
                id: 'ml.apply',
